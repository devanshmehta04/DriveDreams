...
public class PriceComparison {
    public static void main(String[] args) throws IOException {
        ...
        double car1MPG = Double.parseDouble(car1Data.selectFirst(".vehicle-card-details__mpg").text().trim().split("\\s+ ")[0]);
        double car2MPG = Double.parseDouble(car2Data.selectFirst(".vehicle-card-details__mpg").text().trim().split("\\s+ ")[0]);
